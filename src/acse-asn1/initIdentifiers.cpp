...
quint32 CContextListSubSeqOfTransferSyntaxName::s_metaTypeListId = qRegisterMetaType<QLinkedList<CBerObjectIdentifier>*>();
...
namespace {
	...
	quint8 aareAccepted_char[] = { 0x02, 0x01, 0x00 };
